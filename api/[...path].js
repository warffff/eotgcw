...
// Keeps only one Serverless Function in /api while preserving old URLs:
// /api/auth/me, /api/steam-auth/me, /api/content, etc.
...
function getRoute(req){
  ...
  let route = url.pathname.replace(/^\/api\/?/, '').replace(/^\/+|\/+$/g, '');

...
(function(){
  ...
  window.addEventListener('eotg:auth-updated',()=>{ if(location.hash==='#galaxy') { checkGalaxyAccess(); if(galaxyIsUnlocked()) { renderGalaxyPanel(galaxySelected); renderShips(); loadGalaxyEventBookings(true); } } });
})();
